package com.chennann.car.config;

import com.chennann.car.interceptors.LoginInterceptor;
...
//        registry.addInterceptor(loginInterceptor).excludePathPatterns("/librarian/login", "/librarian/add", "/reader/login");
//    }
